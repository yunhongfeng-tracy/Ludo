...
当前 v0.5.4 的搜索也包含奖励再掷：吃子、单子到达 HOME 终点或掷出 6 后，下一次掷骰可能仍属于同一方。决策树根据棋规判断活动玩家，奖励不会被误算成换人。
...
**以下为旧棋规 `basic-ludo-1v1@1` 的历史测试，尚未重新评测 v0.5.4 所使用的吃子与到家奖励再掷规则。** 胜负与胜率均指对战组合左侧 AI，不同批次单独展示，不合并计算。
